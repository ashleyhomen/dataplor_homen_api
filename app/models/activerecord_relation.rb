...
# ActiveRecord::Relation.send(:include, preload_chain)
# ActiveRecord::Relation.send(:include, deep_preload_chain)
# ActiveRecord::Relation.send(:include, preload_reference_chain)
# ActiveRecord::Relation.send(:include, deep_preload_reference_chain)